...
export default function MainContent() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      <div ref={scrollContainerRef} className="snap-y snap-mandatory h-[90vh] mt-[10vh] overflow-scroll overflow-x-hidden scroll-smooth custom-scrollbar" style={{
                                    scrollbarWidth: "none", 
        ...
        <div className="snap-start bg-[#9a8305] h-[90vh] flex flex-col overflow-hidden">
          ...
          <div className="flex flex-grow overflow-hidden">
            ...
            <div
              className={`transition-all duration-500 ease-in-out bg-[#3a3a3a] text-white overflow-hidden ${sidebarOpen ? "md:w-[20vw] w-full p-4" : "w-0 p-0"
                }`}
            >
